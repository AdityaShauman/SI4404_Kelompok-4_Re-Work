    ...
    <div class="container-fluid">
        ...
        <div class="card shadow">
            <div class="card-header py-3">
                <button class="btn btn-info" data-toggle="modal" id="addLoker"><i class="fa fa-plus" aria-hidden="true"></i>
                    Tambah Loker</button>
            </div>
            <div class="card-body">
                <div class="row">
                        ...
                        <tbody>
                            @foreach ($loker as $data)
                                <tr>
                                    ...
                                    <td> {{ $data->foto}}</td>
                                    <td>{{ $data->link }}</td>
                                    <td><a href="{{ route('loker.edit', $data->id) }}" class="btn btn-success">Edit</a>
                                        <a href="{{ route('loker.delete', $data->id) }}"
