    ...
    <div class="container-fluid">
        ...
        <div class="card shadow">
            <div class="card-header py-3">
                <button class="btn btn-info" data-toggle="modal" id="addMateri"><i class="fa fa-plus" aria-hidden="true"></i>
                        ...
                        <tbody>
                            @foreach ($materi as $data)
                                <tr>
                                    ...
                                    <td>{{ $data->media }}</td>
                                    <td><a href="{{ route('materi.edit', $data->id) }}" class="btn btn-success">Edit</a>
                                        <a href="{{ route('materi.delete', $data->id) }}"
